export const tracksFromScratchSegments = [
  {
    id: "tfs1",
    title: "Piano Live From Cary feat. Allen Tan, Jason Dong, Nathan Lee & Brandt Garippo",
    date: "April 2026",
    link: "https://www.youtube.com/embed/zmy6pJjeBNA?start=45",
    originalLink: "https://youtu.be/zmy6pJjeBNA?t=50",
    description:
      "A live acoustic session broadcast directly from Cary Quad with a variety of different piano styles and genres, feat. Allen Tan, Jason Dong, Nathan Lee & Brandt Garippo",
  },
];

export default function TracksFromScratch() {
  return (
              ...
              <div className="w-full md:w-5/12 flex flex-col justify-center text-left h-full">
                ...
                <div className="mt-8">
                  <a
                    ...
                    className="inline-flex bg-red-600 hover:bg-red-500 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-amber-600/30 transition-all hover:-translate-y-1 items-center gap-3"
                  >
