export const purduePlaysSegments = [
  {
    id: "pp1",
    title: "Celeste Any% Race feat. Cynthia Zetlan & LuxRei",
    date: "April 2026",
    link: "https://www.youtube.com/embed/bNhJJ07LEqg?start=12420",
    originalLink: "https://youtu.be/bNhJJ07LEqg?t=12420",
    description:
      "High-speed platforming action as two collegiate runners, Cynthia and LuxRei, go head-to-head!",
  },
  {
    id: "pp2",
    title: "Undertale No Mercy vs. Artist & Chat",
    date: "April 2026",
    link: "https://www.youtube.com/embed/bNhJJ07LEqg?start=15434",
    originalLink: "https://youtu.be/bNhJJ07LEqg?t=15434",
    description:
      "Watch Benjamin run Undertale No Mercy any% while Jayden draws game characters for points to sabotage him!",
  },
];

export default function PurduePlays() {
  return (
    <div className="min-h-screen bg-[#f7f0db] text-slate-900 font-sans py-16 px-4 md:px-8">
      ...
      <div className="max-w-5xl mx-auto text-center mb-20">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto font-bold uppercase tracking-widest">
          Collegiate Esports & Interactive Speedrunning
        </p>
      </div>

      {/* The Broadcast Banners */}
      <div className="max-w-6xl mx-auto flex flex-col gap-16 md:gap-24 pb-20">
        {purduePlaysSegments.map((show, index) => {
          // Alternate layout to keep visual interest
              ...
              <div className="w-full md:w-5/12 flex flex-col justify-center text-left h-full">
                ...
                <div className="mt-8">
                  <a
                    ...
                    className="inline-flex bg-red-600 hover:bg-red-500 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-blue-600/30 transition-all hover:-translate-y-1 items-center gap-3"
                  >
